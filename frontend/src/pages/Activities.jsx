            ...
            <div className="flex j-between a-center" style={{ marginBottom: '32px' }}>
                <div>
                    ...
                    <p style={{ margin: '4px 0 0 0', color: 'var(--text-secondary)', fontSize: '14px' }}>
                        ...
                        <span style={{ marginLeft: '10px', fontSize: '10px', backgroundColor: '#e2e8f0', padding: '2px 6px', borderRadius: '4px', fontWeight: 'bold' }}>v1.5.6-SOUTH-DB</span>
                    </p>
                </div>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', backgroundColor: 'white' }}>
                        ...
                        <tbody>
                            {processedActivities.map((activity) => {
                                ...
                                let fieldDisplayName = field ? field.name : 'SOUTH';
