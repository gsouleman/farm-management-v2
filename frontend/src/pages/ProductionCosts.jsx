    ...
    return (
        <div className="animate-fade-in" style={{ padding: '24px' }}>
            <div style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                <div>
                    <h1 style={{ fontSize: '24px', margin: 0 }}>Production Overview</h1>
                    <p style={{ color: 'var(--text-muted)', fontSize: '14px' }}>
                        Financial breakdown and operational cost configurations for {currentFarm.name}.
                    </p>
                </div>
                <div style={{ display: 'flex', gap: '10px' }}>
                    <button
                        ...
                        style={{
                            padding: '10px 20px',
                            border: 'none',
                            backgroundColor: view === 'overview' ? '#000' : '#e0e0e0',
                            color: view === 'overview' ? '#fff' : '#000',
                            fontWeight: 'bold',
                            cursor: 'pointer'
                        }}
                    >
                    ...
                    <button
                        ...
                        style={{
                            padding: '10px 20px',
                            border: 'none',
                            backgroundColor: view === 'settings' ? '#000' : '#e0e0e0',
                            color: view === 'settings' ? '#fff' : '#000',
                            fontWeight: 'bold',
                            cursor: 'pointer'
                        }}
                    >
                    ...
                    {view === 'overview' && (
                        <button className="primary" onClick={fetchData} disabled={loading} style={{ marginLeft: '10px' }}>
